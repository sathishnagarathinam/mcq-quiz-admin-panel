...
### 8. Sharing Analytics Collection (`/sharing_analytics/{shareId}`)
```json
{
  "examId": "string",
  "shareType": "general|invitation|recommendation|withFiles|result",
  "timestamp": "timestamp",
  "date": "YYYY-MM-DD",
  "userId": "string",
  "userEmail": "string",
  "platform": "mobile|web",
  "shareMethod": "native|social|link",
...
### 9. User Bookmarks Collection (`/user_bookmarks/{userId}`)
```json
{
  "userId": "string",
  "bookmarkedQuestions": [
